...
<head>
    ...
    <title>REMAN ASTO - Profile</title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="editUsername" value="<?= $_SESSION['username'] ?>" disabled>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Name</label>
                                <input type="text" class="form-control" id="editName" value="<?= $_SESSION['name'] ?>" disabled>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" value="<?= $_SESSION['password'] ?>" id="editPassword">
                                <strong class="text-danger">Default Password: 123</strong>
                            </div>
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="btn btn-primary w-100" id="editButton">Edit Data</div>
                                </div>
                                <div class="col">
                                    <div class="btn btn-secondary w-100" id="refresh-button">Reset Form</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#refresh-button').on('click', function () {
            $('#editPassword').val('<?= $_SESSION['password'] ?>');
        });

        // Simpan perubahan pada modal Edit
        $('#editButton').on('click', function () {
            const id = '<?= $_SESSION['id_user'] ?>';
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'editpassword',  // Aksi untuk mengidentifikasi permintaan ini
                    id: id,
                    password: password
                },
