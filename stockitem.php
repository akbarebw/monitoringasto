...
<head>
    ...
    <title>REMAN ASTO - Stock Item</title>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Insert Stock Item Data</h1>
            ...
            <div class="modal-body">
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label">RFU</label>
                        <input type="text" class="form-control" id="addRFU" placeholder="RFU...">
                    </div>
...
<div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Edit Stock Item Data</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label class="form-label">COMPONENT</label>
                    <input type="text" class="form-control" id="editComponent">
                </div>
                <div class="mb-3">
                    <label class="form-label">PN</label>
                    <input type="text" class="form-control" id="editPn">
                </div>
                <div class="mb-3">
                    <label class="form-label">RFU</label>
                    <input type="text" class="form-control" id="editRfu">
                </div>
        ...
        <div class="col main p-3">
            <div class="page-header d-flex flex-column">
                <div class="text-uppercase flex-grow-1 align-content-end mb-2">
                    <h1 style="font-weight: bold">STOCK ITEM</h1>
                </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h5><b>EGI: <span id="label-egi">P410XT</span></b></h5>

                            <div class="my-3 input-group">
                                <label class="input-group-text">Date: <?php echo date('d F Y', time()) ?></label>

                                <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">EGI</button>
                                <ul class="dropdown-menu egidropdownsearch">
                                </ul>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item search-item" href="#">RFU</a></li>
                                </ul>
                            ...
                            <table id="myTable" class="table table-hover">
                                ...
                                <tr class="header" valign="middle">
                                    ...
                                    <th>PN</th>
                                    <th>RFU</th>
                                    <th style="width:5%;" colspan="2">AKSI</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>ENGINE CC13140</td>
                                    <td>2797394</td>
                                    <td> </td>
                                    <td>EDIT</td>
                                </tr>
                    ...
                    <script>
                        function loadEGIListSearch() {
                            $.ajax({
                                url: 'action.php',
                                type: 'POST',
                                data: { action: 'fetchlistegidropdownsearch' },
                                success: function (response) {
                                    $('.egidropdownsearch').html(response);
                                }
                            });
                        }
                        // Muat data awal
                        ...
                        document.querySelectorAll('.search-item').forEach(item => {
                            item.addEventListener('click', function(e) {
                                ...
                                if (selectedColumn === "PN") {
                                    columnIndex = 2;
                                    placeholder = "Search for PN...";
                                } else if (selectedColumn === "RFU") {
                                    columnIndex = 3;
                                    placeholder = "Search for RFU...";
...
<script>
    $(document).ready(function () {
        ...
        function loadData(filter = "P410XT") {
            $.ajax({
                url: 'action.php',
                type: 'POST',
                data: {
                    action: 'fetchstockitem',
                    egi: filter // Kirim nilai EGI jika ada
                },
                success: function (response) {
        ...
        $('#saveData').on('click', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: {
                    action: 'insertstockitem',  // Aksi untuk mengidentifikasi permintaan ini
                    component: component,
                    pn: pn,
                    rfu: rfu,
                    egi: egi
                ...
                success: function (response) {
                    ...
                    loadData(selectedEGI);  // Refresh table or whatever data display you're using
                },
        ...
        $('#saveEditButton').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    loadData(selectedEGI); // Refresh tabel
                }
            });
        });
